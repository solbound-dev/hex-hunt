  ...
  return (
    <div className={c.pageWrapper}>
      ...
      <div className={clsx(c.infoContainer, { [c.open]: showInfo })}>
        ...
        <ul>
          <li>
            Move: Click an adjacent hex to move your character before the timer
            runs out.
          </li>
          <li>
          ...
          <li>
            Collision: If both players move to the same hex, they bounce back to
            their previous positions, and the hex is marked as last known for
            both.
          </li>
          <li>
            Zone: Every 8 moves, the grid shrinks. Players outside the zone die.
          </li>
          <li>
            Visibility: Opponents are only visible at their last known position
            (when they shoot or collect a card).
          </li>
          <li>
